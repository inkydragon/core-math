...
FUNCTIONS_EXHAUSTIVE=(acosf acoshf acospif asinf asinhf asinpif atanf atanhf atanpif cbrtf cbrtf16 cosf coshf cospif erff erfcf expf expf16 exp10f exp10f16 exp10m1f exp2f exp2f16 exp2m1f expm1f hypotf16 lgammaf logf logf16 log10f log10f16 log10p1f log1pf log2f log2f16 log2p1f rsqrtf rsqrtf16 sincosf sinf sinhf sinpif sqrtf16 tanf tanhf tanpif tgammaf)
